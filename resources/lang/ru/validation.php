...
return [
    ...
    */
    ...
    'custom'               => [
        ...
        'is_confirmed' => [
            'accepted' => 'Вы должны принять условия использования сайта!!!'
        ],

        'parent_id' => [
            'required' => 'Произошла ошибка. Попробуйте перегрузить страницу!!!',
            'integer'  => 'Произошла ошибка. Попробуйте перегрузить страницу!!!',
            'exists'  => 'Произошла ошибка. Попробуйте перегрузить страницу!!!'
        ],
